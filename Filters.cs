...
namespace Gwent2
{
    ...
    class Filter
    {
        ...
        public static CardPredicat anyCardHasClan(Clan clan) { return (t) => { return t.clan == clan; }; }
        ...
        public static CardPredicat nonSpyingCard() { return (t) => { return t as Unit == null || !(t as Unit).isSpy; }; }
        ...
        public static CardPredicat anyCardInEnemyDeck(Card source) { return (c) => { return c.place == Place.deck && c.host != source.host; }; }
