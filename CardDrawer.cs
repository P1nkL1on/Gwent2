...
namespace Gwent2
{
    ...
    class CardDrawer
    {
        ...
        PixDrawer drawer = PixDrawer.FromPalette("dd");

        Color bronzeColor = Color.FromArgb(122, 122, 0);
        Color silverColor = Color.FromArgb(160, 162, 162);
        Color goldenColor = Color.FromArgb(255, 122, 0);

        Color neutralColor = Color.FromArgb(110, 40, 22);
        Color skelligeColor = Color.FromArgb(110, 12, 122);
        ...
        Color colorOfRarity(Rarity rare)
        {
            switch (rare)
            {
        ...
        ConsoleColor colorsOfPower(Unit unit)
        {
